            ...
            <div class="container text-center text-md-left">
                ...
                <div class="row text-center text-md-left">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p>
                            <i class="fas fa-home mr-3"></i>21 Block HH, Makhosini Str Soshanguve, RSA
                        </p>
                        <p>
                            <i class="fas fa-envelope mr-3"></i>mafumbukaprimaryschool@gmail.com
                        </p>
                        <p>
                            <i class="fas fa-phone mr-3"></i>+27 12 713 1111
                        </p>
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <p> Copyright &copy;2023 All Rights Reserved by:
                            <a href="" style="text-decoration: none;">
                                <strong class="text-warning">Oamogetswe Mgidi</strong>
                            </a>
                        </p>
                    </div>
